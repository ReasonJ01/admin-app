...
import { Plus, CheckCircle2, XCircle, Trash, Edit } from "lucide-react";
...
function ReviewRow({ review, onDelete, onEdit }: ReviewRowProps) {
    ...
    return (
        <Card key={review.id} className={`border-2 ${review.isApproved ? 'border-green-500 bg-green-50/50' : 'border-orange-500 bg-orange-50/50'}`}>
            <CardHeader>
